...
KNOWN_KEYS = {
    ...
    # Violations
    "Olivia Violations": "violationsTitle",
    ...
    # Law Library
    "Olivia Law Library": "lawLibTitle",
    "59 legal sources (codes, laws, regulations, treaties) with verbatim text and SHA-256.": "lawLibDesc",
    "Open full view": "lawLibOpen",
    # Memory
    "Olivia Memory": "memoryTitle",
    "Explore, query, and configure all Olivia memory. Vector, semantic, graph, short-term, and long-term.": "memoryDesc",
    ...
    "Olivia Assistant": "studioAiAssistant",
